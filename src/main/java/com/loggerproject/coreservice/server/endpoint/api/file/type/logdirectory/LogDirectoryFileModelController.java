package com.loggerproject.coreservice.server.endpoint.api.file.type.logdirectory;
...
import com.loggerproject.coreservice.server.service.filedata.type.logdirectory.delete.LogDirectoryFileModelDeleteService;
...
public class LogDirectoryFileModelController extends AFileModelController {
    ...
    @Autowired
    public LogDirectoryFileModelController(LogDirectoryFileModelCreateService globalServerCreateService,
