package com.loggerproject.coreservice.server.endpoint.api.file.a;
...
public abstract class AFileModelController {
    ...
    public AFileModelController(AFileModelCreateService globalServerCreateService,
        ...
        this.genericClass = GenericTypeResolver.resolveTypeArgument(getClass(), AFileModelController.class);
